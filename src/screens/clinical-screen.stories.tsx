...
import { DetailPageTemplate } from "../layout/detail-page-template";
import { ClinicalDecisionSupportAlert } from "../workflow/clinical-decision-support-alert";
import { FactBox, FactBoxTile, FactBoxField, FactBoxMetric } from "../layout/fact-box";
import { OmnichannelContactBar } from "../layout/omnichannel-contact-bar";
