...
/**
 * BimModelViewerToolbar provides viewport navigation, camera projection switching,
 * clipping plane manipulation, linear measurement, and layer visibility controls for 3D BIM models.
 *
 * @maturity stable
 */
export const BimModelViewerToolbar = forwardRef<
  HTMLElement,
  BimModelViewerToolbarProps
>(
  (
    {
    ...
    return (
      ...
      >
        ...
        <div
          role="toolbar"
          aria-label="Camera and Viewport Tools"
        ...
        >
          ...
          <div
            ...
            role="group"
            aria-label="Camera Navigation Modes"
          >
            <button
              type="button"
              className={`${styles.toolBtn} ${
                cameraMode === "orbit" ? styles.btnActive : ""
              }`}
            ...
            <button
              type="button"
              className={`${styles.toolBtn} ${
                cameraMode === "pan" ? styles.btnActive : ""
              }`}
            ...
            <button
              type="button"
              className={`${styles.toolBtn} ${
                cameraMode === "walk" ? styles.btnActive : ""
              }`}
          ...
          <div
            className={styles.toolGroup}
            role="group"
            aria-label="Section and Clipping Planes"
          >
            <button
              type="button"
              className={`${styles.toolBtn} ${
                sectionMode === "x_plane" ? styles.btnActive : ""
              }`}
            ...
            <button
              type="button"
              className={`${styles.toolBtn} ${
                sectionMode === "z_plane" ? styles.btnActive : ""
              }`}
          ...
          >
            <button
              type="button"
              className={`${styles.toolBtn} ${
                measureTool === "distance" ? styles.btnActive : ""
              }`}
          ...
          <div
            className={styles.toolGroup}
            role="group"
            aria-label="Model Discipline Layers"
          >
            <button
              type="button"
              className={`${styles.pillBtn} ${
                disciplines.architectural ? styles.pillActive : ""
              }`}
            ...
            <button
              type="button"
              className={`${styles.pillBtn} ${
                disciplines.structural ? styles.pillActive : ""
              }`}
            ...
            <button
              type="button"
              className={`${styles.pillBtn} ${
                disciplines.mep ? styles.pillActive : ""
              }`}
            ...
            <button
              type="button"
              className={`${styles.pillBtn} ${
                disciplines.hvac ? styles.pillActive : ""
              }`}
...
BimModelViewerToolbar.displayName = "BimModelViewerToolbar";
