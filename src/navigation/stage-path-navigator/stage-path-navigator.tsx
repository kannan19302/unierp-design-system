...
export interface StagePathNavigatorProps extends React.HTMLAttributes<HTMLElement> {
...
/**
 * StagePathNavigator displays a linear chevron lifecycle path
 * indicating the current milestone, completed stages, and next actions.
 *
 * @maturity stable
 */
export const StagePathNavigator = forwardRef<HTMLElement, StagePathNavigatorProps>(
  (
    {
      stages,
      activeStageId,
...
StagePathNavigator.displayName = "StagePathNavigator";
