...
export interface GuidedFlowStepNavigatorProps extends React.HTMLAttributes<HTMLElement> {
  steps: GuidedStep[];
  activeStepId: string;
...
/**
 * GuidedFlowStepNavigator provides a multistep progress bar and step list
 * for sequential ERP onboarding, guided setup wizards, and verification checklists.
 *
 * @maturity stable
 */
export const GuidedFlowStepNavigator = forwardRef<HTMLElement, GuidedFlowStepNavigatorProps>(
  (
    {
      steps,
      activeStepId,
...
GuidedFlowStepNavigator.displayName = "GuidedFlowStepNavigator";
