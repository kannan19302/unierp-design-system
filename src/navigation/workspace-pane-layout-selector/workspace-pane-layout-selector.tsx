...
export interface WorkspacePaneLayoutSelectorProps extends React.HTMLAttributes<HTMLDivElement> {
...
/**
 * WorkspacePaneLayoutSelector provides rapid multi-pane dock arrangement,
 * toggling navigation, terminal, and inspector panels.
 *
 * @maturity stable
 */
export const WorkspacePaneLayoutSelector = forwardRef<HTMLDivElement, WorkspacePaneLayoutSelectorProps>(
  (
    {
      visibility,
      onTogglePane,
...
WorkspacePaneLayoutSelector.displayName = "WorkspacePaneLayoutSelector";
