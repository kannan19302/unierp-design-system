...
export interface CatalogSchemaExplorerTreeProps extends React.HTMLAttributes<HTMLElement> {
  catalogName?: string;
...
/**
 * CatalogSchemaExplorerTree provides a hierarchical metadata navigation tree
 * for enterprise data lakes, relational schemas, and data warehouse tables.
 *
 * @maturity stable
 */
export const CatalogSchemaExplorerTree = forwardRef<HTMLElement, CatalogSchemaExplorerTreeProps>(
  (
    {
      ...
      density = "compact",
      className = "",
      testId = "catalog-schema-explorer-tree",
      ...rest
    },
    ref
  ) => {
...
CatalogSchemaExplorerTree.displayName = "CatalogSchemaExplorerTree";
