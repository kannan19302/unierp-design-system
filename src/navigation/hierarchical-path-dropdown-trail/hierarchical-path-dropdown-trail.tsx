...
export interface HierarchicalPathDropdownTrailProps extends React.HTMLAttributes<HTMLElement> {
...
/**
 * HierarchicalPathDropdownTrail provides an enhanced breadcrumb trail where each
 * hierarchy level reveals a dropdown selector for immediate sibling navigation.
 *
 * @maturity stable
 */
export const HierarchicalPathDropdownTrail = forwardRef<HTMLElement, HierarchicalPathDropdownTrailProps>(
  (
    {
      segments,
      onSegmentClick,
...
HierarchicalPathDropdownTrail.displayName = "HierarchicalPathDropdownTrail";
