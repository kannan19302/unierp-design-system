...
export interface MasterDetailSplitNavigatorProps extends React.HTMLAttributes<HTMLElement> {
  currentIndex: number;
  totalCount: number;
...
/**
 * MasterDetailSplitNavigator provides a navigation toolbar for stepping through master records
 * with split screen ratio adjustments and review audit progress telemetry.
 *
 * @maturity stable
 */
export const MasterDetailSplitNavigator = forwardRef<HTMLElement, MasterDetailSplitNavigatorProps>(
  (
    {
      currentIndex,
      totalCount,
...
MasterDetailSplitNavigator.displayName = "MasterDetailSplitNavigator";
