...
export interface FacetedFilterNavigationRailProps extends React.HTMLAttributes<HTMLElement> {
...
/**
 * FacetedFilterNavigationRail provides a side navigation rail for faceted searching,
 * category attribute filtering, and multi-select aggregation refinement.
 *
 * @maturity stable
 */
export const FacetedFilterNavigationRail = forwardRef<HTMLElement, FacetedFilterNavigationRailProps>(
  (
    {
      groups,
      selectedOptionIds,
...
FacetedFilterNavigationRail.displayName = "FacetedFilterNavigationRail";
