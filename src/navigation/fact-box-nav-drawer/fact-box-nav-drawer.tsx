...
export interface FactBoxNavDrawerProps extends React.HTMLAttributes<HTMLElement> {
  cards: FactBoxCard[];
  isCollapsed?: boolean;
...
/**
 * FactBoxNavDrawer provides a Business Central style collateral telemetry pane
 * displaying contextual cards, financial metrics, and drilldown navigation links.
 *
 * @maturity stable
 */
export const FactBoxNavDrawer = forwardRef<HTMLElement, FactBoxNavDrawerProps>(
  (
    {
      cards,
      isCollapsed = false,
...
FactBoxNavDrawer.displayName = "FactBoxNavDrawer";
