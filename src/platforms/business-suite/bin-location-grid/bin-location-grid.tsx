...
/**
 * `<BinLocationGrid>` — Manhattan Associates & Blue Yonder benchmarked 2D warehouse rack matrix.
 *
 * @maturity stable
 */
export const BinLocationGrid = forwardRef<HTMLDivElement, BinLocationGridProps>(
  (
    {
      aisleCode,
      bays,
                      ...
                      >
                        ...
                        <div className={styles.capacityBar} aria-hidden="true">
                          <div
                            ...
                            style={{ inlineSize: `${bin.capacityPercent}%` }}
                          />
                        </div>
...
BinLocationGrid.displayName = "BinLocationGrid";
