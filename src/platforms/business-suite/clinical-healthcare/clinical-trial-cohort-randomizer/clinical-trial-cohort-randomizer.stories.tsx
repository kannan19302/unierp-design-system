...
const meta: Meta<typeof ClinicalTrialCohortRandomizer> = {
  title: "Platforms/BusinessSuite/ClinicalHealthcare/ClinicalTrialCohortRandomizer",
...
export const AnatomyAndComposition: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px", maxWidth: "900px" }}>
      <div>
        <h4 style={{ margin: "0 0 8px 0" }}>Double-Blind Protocol Randomization Layout</h4>
        <ClinicalTrialCohortRandomizer protocol={mockProtocol} density="compact" />
      </div>
    </div>
  ),
};
...
export const AllStatesGallery: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "32px", maxWidth: "900px" }}>
      <div>
        <h4 style={{ margin: "0 0 8px 0" }}>Standard Double-Blind Protocol</h4>
        <ClinicalTrialCohortRandomizer protocol={mockProtocol} density="compact" />
      </div>
      <div>
        <h4 style={{ margin: "0 0 8px 0" }}>Comfortable Density</h4>
        <ClinicalTrialCohortRandomizer protocol={mockProtocol} density="comfortable" />
      </div>
    </div>
  ),
};
