...
/**
 * TopologyDependencyGraph visualizes multi-service microservice and data pipeline topologies with live cluster health.
 *
 * @maturity stable
 */
export const TopologyDependencyGraph = forwardRef<HTMLDivElement, TopologyDependencyGraphProps>(
  (
    {
...
TopologyDependencyGraph.displayName = "TopologyDependencyGraph";
