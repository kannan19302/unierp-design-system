...
/**
 * TaxWithholdingComplianceCockpit manages IRS 1099 statutory compliance, TIN matching, and backup withholding.
 *
 * @maturity stable
 */
export const TaxWithholdingComplianceCockpit = forwardRef<HTMLElement, TaxWithholdingComplianceCockpitProps>(
  (
    {
      taxYear = 2026,
      vendors,
...
TaxWithholdingComplianceCockpit.displayName = "TaxWithholdingComplianceCockpit";
