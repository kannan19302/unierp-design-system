import React, { forwardRef, useId, useState, useMemo } from "react";
...
/**
 * ServiceCatalogCartCheckout manages IT service provisioning carts, cost center allocation, and approval flows.
 *
 * @maturity stable
 */
export const ServiceCatalogCartCheckout = forwardRef<HTMLElement, ServiceCatalogCartCheckoutProps>(
  (
    {
      requestId,
      requesterName,
...
ServiceCatalogCartCheckout.displayName = "ServiceCatalogCartCheckout";
