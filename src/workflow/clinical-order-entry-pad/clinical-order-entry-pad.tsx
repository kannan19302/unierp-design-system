...
/**
 * `<ClinicalOrderEntryPad>` — Enterprise Computerized Physician Order Entry (CPOE) Pad.
 *
 * @maturity stable
 */
export const ClinicalOrderEntryPad = forwardRef<
  HTMLElement,
  ClinicalOrderEntryPadProps
>(
  (
    {
      patient,
    ...
    const [stagedOrders, setStagedOrders] =
      useState<StagedClinicalOrder[]>(initialOrders);
    const [activeCategory, setActiveCategory] =
      useState<OrderCategory>("medication");
    const [signaturePin, setSignaturePin] = useState<string>("" );
    const [signed, setSigned] = useState<boolean>(false);
    const [overrideAcknowledged, setOverrideAcknowledged] =
    ...
    const [newOrderPriority, setNewOrderPriority] =
      useState<OrderPriority>("routine");

    const hasContraindications = stagedOrders.some(
      (o) => !!o.contraindicationWarning
    );
    ...
    const handleAddOrder = (e: React.FormEvent) => {
      ...
      const newOrder: StagedClinicalOrder = {
        ...
        details:
          newOrderDetails.trim() || "As directed by standard ICU protocol",
    ...
    return (
      <section
        ref={ref}
        className={`${styles.container} ${styles[density]}${className ? ` ${className}` : ""}`}
          ...
          <div className={styles.allergyCorridor}>
            ...
            <div className={styles.allergyTags}>
              {patient.allergies.length > 0 ? (
                ...
                <span className={styles.noAllergies}>
        ...
        {hasContraindications && (
          <div className={styles.contraindicationAlert} role="alert">
            ...
            <div className={styles.alertText}>
              ...
              more staged orders conflict with recorded patient allergy
              contraindications. An explicit attending physician override is
              ...
              <div className={styles.overrideCheckWrap}>
                <label className={styles.overrideLabel}>
                  ...
                  />
                  I acknowledge the clinical risk and certify medical necessity
                  override.
                </label>
              </div>
            </div>
              ...
              <div className={styles.formRow}>
                ...
                <div className={styles.inputWrapNarrow}>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewOrderPriority(e.target.value as OrderPriority)
                    }
                  >
...
ClinicalOrderEntryPad.displayName = "ClinicalOrderEntryPad";
