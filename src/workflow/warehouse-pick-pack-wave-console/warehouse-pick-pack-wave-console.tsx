...
/**
 * WarehousePickPackWaveConsole manages multi-order wave picking, tote assignments, and barcode verification.
 *
 * @maturity stable
 */
export const WarehousePickPackWaveConsole = forwardRef<HTMLElement, WarehousePickPackWaveConsoleProps>(
  (
    {
...
WarehousePickPackWaveConsole.displayName = "WarehousePickPackWaveConsole";
