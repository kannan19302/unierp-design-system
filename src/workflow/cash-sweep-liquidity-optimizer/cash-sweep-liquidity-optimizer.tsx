...
/**
 * `<CashSweepLiquidityOptimizer>` — Enterprise Multi-Tier Cash Sweep & ZBA Liquidity Optimizer.
 *
 * @maturity stable
 */
export const CashSweepLiquidityOptimizer = forwardRef<
  HTMLElement,
      ...
      >
          ...
          <div className={styles.badgeRow}>
            ...
            <span
              className={`${styles.statusPill} ${
                isExecuted ? styles.pillExecuted : styles.pillPending
              }`}
            >
              {isExecuted
                ? "TRANSFERS DISPATCHED"
                : "REBALANCE PROPOSAL READY"}
            </span>
          </div>
          <div className={styles.titleRow}>
            ...
            <label className={styles.autoSweepToggle}>
              ...
              <span className={styles.toggleText}>
                Automated End-of-Day Sweep (17:00 EST)
              </span>
            </label>
          </div>
        </header>
        ...
        <div className={styles.kpiGrid}>
          <div className={styles.kpiCard}>
            ...
            <span className={styles.kpiSub}>
              {accounts.length} linked treasury nodes
            </span>
          </div>
          <div className={styles.kpiCard}>
          ...
          <div className={styles.kpiCard}>
            ...
            <span className={styles.kpiSub}>
              Required to meet target floors
            </span>
          </div>
          <div className={styles.kpiCard}>
        ...
        <div className={styles.tableWrapper}>
          <table
            ...
            aria-label="Treasury accounts sweep allocation schedule"
          >
            <thead>
              <tr>
            ...
            <tbody>
              {sweepCalculations.map((acc) => (
                <tr
                  key={acc.id}
                  className={
                    acc.id === masterAccount?.id ? styles.masterRow : ""
                  }
                >
                  <td>
                  ...
                  <td>
                    <div className={styles.typeBadge}>
                      ...
                      <span className={styles.apyText}>
                        {acc.apyRate > 0 ? `${acc.apyRate}% APY` : "0.0%"}
                      </span>
                    </div>
                  </td>
                  ...
                  <td className={styles.numCell}>
                    {formatCurrency(acc.targetFloorBalance, acc.currency)}
                  </td>
                  <td className={styles.numCell}>
                    <span
                      className={
        ...
        <footer className={styles.footer}>
          ...
          <div className={styles.footerActions}>
            <button
              ...
              disabled={
                isExecuted ||
                sweepCalculations.every((a) => a.proposedTransfer === 0)
              }
              aria-label="Authorize and execute cash sweep transfers"
            >
              {isExecuted
                ? "Sweeps Transferred"
                : "Authorize Batch Rebalance"}
            </button>
          </div>
        </footer>
      </section>
...
CashSweepLiquidityOptimizer.displayName = "CashSweepLiquidityOptimizer";
