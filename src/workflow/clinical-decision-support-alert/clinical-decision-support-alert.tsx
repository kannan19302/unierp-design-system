...
/**
 * `<ClinicalDecisionSupportAlert>` — Healthcare CDS Hooks & Clinical Safety Guardrail Alert.
 *
 * @maturity stable
 */
export const ClinicalDecisionSupportAlert = forwardRef<
  HTMLElement,
  ClinicalDecisionSupportAlertProps
>(
  (
    {
      alertId,
    ...
    return (
      <section
        ref={ref}
        className={`${styles.container} ${styles[`severity_${severity}`]}${className ? ` ${className}` : ""}`}
          ...
          <div className={styles.patientContext}>
            ...
            {patient.egfr !== undefined && (
              <div className={styles.patientItem}>
                ...
                <span
                  className={
                    patient.egfr < 30 ? styles.alertVal : styles.patientVal
                  }
                >
            ...
            {patient.allergies && patient.allergies.length > 0 && (
              <div className={styles.patientItem}>
                ...
                <span className={styles.allergyVal}>
        ...
        <div className={styles.body}>
          ...
          <div className={styles.explanationCard}>
            <h3 className={styles.sectionHeader}>
              Clinical Hazard &amp; Interaction Details
            </h3>
                    ...
                    {recommendations.map((rec) => (
                      <div key={rec.id} className={styles.recCard}>
                        <div className={styles.recInfo}>
                          ...
                          {rec.suggestedDose && (
                            <span className={styles.recDose}>
                              Suggested: {rec.suggestedDose}
                            </span>
                          )}
                        </div>
                        <button
...
ClinicalDecisionSupportAlert.displayName = "ClinicalDecisionSupportAlert";
