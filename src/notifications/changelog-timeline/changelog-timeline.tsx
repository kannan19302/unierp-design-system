...
export interface ChangelogEntry {
  version: string;
  date: string;
  changes: { type: "feat" | "fix" | "breaking"; text: string }[];
}

/**
 * ChangelogTimeline component displaying version releases, features, bug fixes, and breaking changes.
 *
 * @maturity stable
 */
export const ChangelogTimeline = forwardRef<HTMLDivElement, ChangelogTimelineProps>(function ChangelogTimeline(
  { entries, className = "" },
  ref
) {
  const typeColors = {
