...
/**
 * PresenceIndicator component indicating real-time agent or collaborator status.
 *
 * @maturity stable
 */
  ...
  function PresenceIndicator(
    ...
    return (
      <div
        ...
        role="status"
        aria-label={`${name || "User"} is ${labels[status]}`}
      >
        <div style={{ position: "relative", width: sz, height: sz }}>
          <div
            style={{
              ...
              background: avatar ? undefined : "var(--color-brand-subtle)",
              display: "flex",
              alignItems: "center",
        ...
        {name && (
          <div>
            <div style={{ fontSize: "var(--text-sm)", fontWeight: "var(--weight-medium, 500)" }}>
              {name}
            </div>
            {statusMessage && (
