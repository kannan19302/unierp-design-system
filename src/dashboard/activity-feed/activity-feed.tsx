    ...
    return (
      ...
      >
        <div className={styles.header}>
          ...
          >
            <Activity
              size={16}
              style={{
                color: "var(--platform-accent, var(--color-primary))",
              }}
            />
        ...
        {displayItems.length === 0 ? (
          <p
            style={{
              fontSize: "var(--type-label, var(--text-xs))",
                  ...
                  <div className={styles.content}>
                    <div className={styles.meta_row}>
                      ...
                      >
                        ...
                        <Badge
                          variant={actionVariantMap[item.action] || "secondary"}
                          size="sm"
                        >
                          {item.action}
                        </Badge>
                        ...
                        >
                          ...
                          >
                            ...
                            <span>
                              {isDiffOpen
                                ? "Hide changes"
                                : `View ${item.diffs!.length} field change(s)`}
                            </span>
                          </span>
                        </button>
                        ...
                        {isDiffOpen && (
                          <div className={styles.diff_panel}>
                            {item.diffs!.map((diff, dIdx) => (
                              <div
                                key={`diff-${dIdx}`}
                                className={styles.diff_row}
                              >
                                <span className={styles.diff_key}>
                                  {diff.field}:
                                </span>
