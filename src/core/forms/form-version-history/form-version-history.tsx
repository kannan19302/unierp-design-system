...
export const FormVersionHistory = React.forwardRef<
  HTMLDivElement,
  FormVersionHistoryProps
>((props, ref) => {
  const { versions, onRestore } = props;
  return (
    <div ref={ref} className={styles.container} role="region" aria-label="Form version history">
...
FormVersionHistory.displayName = "FormVersionHistory";
