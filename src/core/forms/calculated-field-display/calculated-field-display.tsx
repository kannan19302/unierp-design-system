...
export const CalculatedFieldDisplay = React.forwardRef<
  HTMLDivElement,
  CalculatedFieldDisplayProps
>((props, ref) => {
  const { label, formula, value, breakdown } = props;
  return (
    <div ref={ref} className={styles.container} role="region" aria-label={label}>
      ...
      {breakdown && (
        <div className={styles.content} style={{ marginTop: "var(--space-3)" }}>
          {breakdown.map((b, i) => (
...
CalculatedFieldDisplay.displayName = "CalculatedFieldDisplay";
