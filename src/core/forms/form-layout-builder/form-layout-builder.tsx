...
export const FormLayoutBuilder = React.forwardRef<
  HTMLDivElement,
  FormLayoutBuilderProps
>((props, ref) => {
  const { sections } = props;
  return (
    <div ref={ref} className={styles.container} role="region" aria-label="Form layout builder">
      <div className={styles.header}>
        <h3 className={styles.title}>Form Layout Builder</h3>
      </div>
