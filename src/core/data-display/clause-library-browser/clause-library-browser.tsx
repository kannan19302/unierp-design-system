...
/**
 * Enterprise legal clause library browser with multi-pane preview and risk level filtering.
 *
 * @maturity stable
 */
export const ClauseLibraryBrowser = forwardRef<HTMLElement, ClauseLibraryBrowserProps>(
  function ClauseLibraryBrowser(
    {
...
ClauseLibraryBrowser.displayName = "ClauseLibraryBrowser";
