import { useState, useId, useMemo, forwardRef } from "react";
...
/**
 * CashFlowForecastWaterfall component for modeling deterministic cash liquidity bridges.
 *
 * @maturity stable
 */
export const CashFlowForecastWaterfall = forwardRef<HTMLElement, CashFlowForecastWaterfallProps>(
  (
    {
      ...
      >
        ...
        <div className={styles.waterfallCanvas} role="region" aria-label="Cash Waterfall Chart">
          <div
            ...
            style={{ insetBlockEnd: `${(minimumCashBuffer / maxVal) * 100}%` }}
                ...
                >
                  ...
                  <div className={styles.barTrack}>
                    <div
                      ...
                      style={{
                        insetBlockEnd: `${bottomPct}%`,
                        blockSize: `${Math.max(heightPct, 2)}%`,
                      }}
                    />
                  </div>
...
CashFlowForecastWaterfall.displayName = "CashFlowForecastWaterfall";
