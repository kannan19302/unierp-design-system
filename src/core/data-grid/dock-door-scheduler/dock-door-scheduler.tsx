...
/**
 * `<DockDoorScheduler>` — Cross-dock and yard appointment matrix with detention risk tracking and real-time status dispatch.
 *
 * @maturity stable
 */
export const DockDoorScheduler = forwardRef<HTMLElement, DockDoorSchedulerProps>(
  (
    {
...
DockDoorScheduler.displayName = "DockDoorScheduler";
