...
/**
 * `<BillOfMaterialsTreeGrid>` — Hierarchical manufacturing tree grid with PLM revision control, ECO tracking, and cost rollups.
 *
 * @maturity stable
 */
export const BillOfMaterialsTreeGrid = forwardRef<HTMLElement, BillOfMaterialsTreeGridProps>(
  (
    {
      assemblyPartNumber,
      assemblyTitle,
            ...
            >
              ...
              <td className={styles.tdPart}>
                <div
                  ...
                  style={{ paddingInlineStart: `calc(${depth} * var(--space-4, 1rem))` }}
                >
                  {hasChildren ? (
                    <button
                      type="button"
...
BillOfMaterialsTreeGrid.displayName = "BillOfMaterialsTreeGrid";
