...
/**
 * `<DatabaseGrantPrivilegeMatrix>` — Snowflake & Databricks inspired role-based database catalog security grant matrix.
 *
 * @maturity stable
 */
export const DatabaseGrantPrivilegeMatrix = forwardRef<HTMLElement, DatabaseGrantPrivilegeMatrixProps>(
  (
    {
...
DatabaseGrantPrivilegeMatrix.displayName = "DatabaseGrantPrivilegeMatrix";
