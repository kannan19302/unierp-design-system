...
/**
 * `<CrossFilterFacetPanel>` — Power BI & Tableau benchmarked multi-faceted cross-filtering control panel.
 *
 * @maturity stable
 */
export const CrossFilterFacetPanel = forwardRef<HTMLElement, CrossFilterFacetPanelProps>(
  (
    {
...
CrossFilterFacetPanel.displayName = "CrossFilterFacetPanel";
