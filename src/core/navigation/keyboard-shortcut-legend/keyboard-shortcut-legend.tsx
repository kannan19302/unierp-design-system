...
export interface KeyboardShortcutLegendProps extends React.HTMLAttributes<HTMLDivElement> {
...
/**
 * KeyboardShortcutLegend provides an accessible modal cheat sheet documenting
 * system keyboard accelerators, hotkeys, and power-user workflows.
 *
 * @maturity stable
 */
export const KeyboardShortcutLegend = forwardRef<HTMLDivElement, KeyboardShortcutLegendProps>(
  (
    {
      shortcuts,
      isOpen = true,
...
KeyboardShortcutLegend.displayName = "KeyboardShortcutLegend";
