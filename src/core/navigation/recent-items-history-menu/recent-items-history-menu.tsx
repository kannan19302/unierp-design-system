...
export interface RecentItemsHistoryMenuProps extends React.HTMLAttributes<HTMLDivElement> {
...
/**
 * RecentItemsHistoryMenu provides an MRU (Most Recently Used) navigation popover
 * tracking recently accessed records, views, and pinned favorite entities.
 *
 * @maturity stable
 */
export const RecentItemsHistoryMenu = forwardRef<HTMLDivElement, RecentItemsHistoryMenuProps>(
  (
    {
      items,
      onItemClick,
...
RecentItemsHistoryMenu.displayName = "RecentItemsHistoryMenu";
