...
export interface WorkspaceTabsProps extends React.HTMLAttributes<HTMLElement> {
...
/**
 * WorkspaceTabs component manages multi-document sessions across complex ERP workflows,
 * supporting pinning, dirty state indicators, context menus, and keyboard navigation.
 *
 * @maturity stable
 */
export const WorkspaceTabs = forwardRef<HTMLElement, WorkspaceTabsProps>(
  (
    {
      tabs,
      activeTabId,
