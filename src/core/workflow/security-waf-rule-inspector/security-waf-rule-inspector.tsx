...
/**
 * SecurityWafRuleInspector displays real-time edge WAF event telemetry and threat mitigation controls.
 *
 * @maturity stable
 */
export const SecurityWafRuleInspector = forwardRef<HTMLElement, SecurityWafRuleInspectorProps>(
  (
    {
...
SecurityWafRuleInspector.displayName = "SecurityWafRuleInspector";
