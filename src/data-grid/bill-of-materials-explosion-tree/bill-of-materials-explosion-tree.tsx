...
/**
 * `<BillOfMaterialsExplosionTree>` — Multilevel manufacturing BOM explosion tree with roll-up costing and shortages analysis.
 *
 * @maturity stable
 */
export const BillOfMaterialsExplosionTree = forwardRef<HTMLElement, BillOfMaterialsExplosionTreeProps>(
  (
    {
                  ...
                  <tr key={row.node.id} className={styles.rowItem}>
                    <td className={styles.treeCell}>
                      <div
                        ...
                        style={{ paddingInlineStart: `calc(${row.depth} * var(--space-4))` }}
                      >
                        {row.hasChildren ? (
                          <button
                            type="button"
...
BillOfMaterialsExplosionTree.displayName = "BillOfMaterialsExplosionTree";
