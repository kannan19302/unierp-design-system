import { useId, useState, useMemo, forwardRef } from "react";
...
/**
 * `<DnsZoneRecordEditor>` — Authoritative DNS zone file editor with Cloudflare-style proxy toggles and BIND export.
 *
 * @maturity stable
 */
export const DnsZoneRecordEditor = forwardRef<HTMLElement, DnsZoneRecordEditorProps>(
  (
    {
      zoneName,
      records,
...
DnsZoneRecordEditor.displayName = "DnsZoneRecordEditor";
