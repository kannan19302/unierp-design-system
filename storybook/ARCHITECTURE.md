# Architecture Specification: UniERP Storybook Component Workshop (`storybook`)
...
### Boundary Contract
- **Allowed Inbound Consumers**: Internal designers and engineers
...
- **Core Runtime & Languages**: Storybook 8, React, Vite
- **Primary Interface**: `@kannan19302/storybook`
- **Verification Harness**: `pnpm build-storybook`
...
- **Project Skill**: [`.agents/skills/storybook-standards/SKILL.md`](.agents/skills/storybook-standards/SKILL.md)
